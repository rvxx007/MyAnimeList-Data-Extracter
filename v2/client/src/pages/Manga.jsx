...
const Manga = () => {
  ...
  return (
    ...
    <FilterNav dt={mangaData} tyArr={mangaTyArr} nxobj={[nxtPage, setNxtPage]} tyobj={[type, setType]}/>
    </header>
    <section className=" flex w-full h-full justify-center items-center gap-4 flex-wrap">

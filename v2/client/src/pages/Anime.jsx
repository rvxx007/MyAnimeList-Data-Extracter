...
const AnimeTyArr =[{value:"airing",name:"Top Airing"},
  ...
  return (
    ...
    <header style={{border:"1px solid red"}} className="w-full">
    <FilterNav dt={animeData} tyArr={AnimeTyArr} nxobj={[nxtPage, setNxtPage]} tyobj={[type, setType]}/>
    </header>
    <section style={{border:"1px solid red"}} 
    className=" h-full flex justify-start items-center gap-4 flex-wrap">

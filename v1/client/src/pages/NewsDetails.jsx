   ...
   <>
    ...
    <div className='flex flex-col xl:flex-row justify-center xl:justify-between items-center xl:items-start gap-6'>
      ...
      <div  className='w-full flex flex-col justify-between items-center gap-6'>
        ...
        <h1 className='w-full text-4xl text-start md:text-center xl:text-start font-bold'>{nData?.title}</h1>
      ...
      <div  className='w-full flex flex-col  justify-between items-center gap-6'>
        ...
        {nData.video && <iframe className=' w-full h-[200px] md:h-[900px] border-2 border-double border-gray-250 shadow-xl rounded-lg' src={nData && nData.video.src} >
        </iframe>}
        <div >
        </div>
      </div>
